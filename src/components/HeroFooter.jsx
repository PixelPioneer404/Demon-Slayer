...
import { Facebook, Github, Instagram, Linkedin, Volume2, VolumeOff } from 'lucide-react';
...
const HeroFooter = (props) => {
    ...
    return (
        <div className="absolute bottom-0 left-0 w-full h-20 flex justify-between items-center px-8 z-999">
            <span className="text-white text-[32px] mb-20" onClick={handleScrollToNext}>
                <img src={arrowSVG} alt="Arrow" className="w-15 h-15 animate-up-down hover:scale-120 active:scale-100 cursor-pointer transition-all duration-300 ease-in-out" />
            </span>
